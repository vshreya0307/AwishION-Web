...
var firestore = firebase.firestore();
  ...
  const db = firestore.collection("editproject");
...
//   });
// });
const db1 = firestore.collection("userdetails");
...
(document.getElementById("project")).innerHTML= '<img class="profile_image" src="'+url+'" >';
